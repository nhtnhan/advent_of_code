d = ''''''
i = {
'NQT' : ['TXC', 'RVJ'],
'FPT' : ['PNS', 'KJL'],
'BNQ' : ['THG', 'LCV'],
...
def one(direction, input_dict):
    ...
    while current != 'ZZZ':
        ...
        current = input_dict[current][left_or_right_i]
