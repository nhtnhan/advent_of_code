...
def compare_same_type(first, second):
    for i in range(len(first)):
        if card_to_value[first[i]] > card_to_value[second[i]]:
            return 1
        if card_to_value[first[i]] < card_to_value[second[i]]:
            return -1
...
def compare_same_type2(first, second):
    for i in range(len(first)):
        if card_to_value2[first[i]] > card_to_value2[second[i]]:
            return 1
        if card_to_value2[first[i]] < card_to_value2[second[i]]:
            return -1
